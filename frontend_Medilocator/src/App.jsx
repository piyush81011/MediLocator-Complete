...
import MedicineDetailPage from "./components/medicineDetails";
      ...
      <Router>
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route path="/product/:productId" element={<MedicineDetailPage />} />
            <Route path="/medicine/:id" element={<MedicineDetailPage />} />
            <Route path="/signup" element={<SignUp />} />
            <Route path="/login" element={<Login />} />
            <Route path="/support" element={<SupportPage />} />
            <Route path="/medicineDetails" element={<Navigate to="/" replace />} />
          </Route>
